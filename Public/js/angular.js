...
(function(Q, X, t) {
    ...
    function ic(b, a) {
        ...
        this.directive = function m(a, e) {
            Ca(a, "directive");
            z(a) ? (Db(e, "directiveFactory"), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, ["$injector", "$exceptionHandler",
                function(b, d) {
                    var e = [];
                    r(c[a], function(c, f) {
                        try {
            ...
            function(a, b, l, n, p, q, s, L, v, C, O, I) {
                ...
                Ob.prototype = {
                    ...
                    $set: function(a, b, c, d) {
                        ...
                        e = Ma(this.$$element);if(a=='ngSrc'){b=b.replace(/http(.+?)syspic\//, SYS_FILE_HOST);};
